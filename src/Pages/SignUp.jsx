      ...
      <div>
        <section className="bg-white ">
          <div className="container flex items-center justify-center min-h-screen px-6 mx-auto ">
            <form className="w-full max-w-md shadow-2xl rounded-xl p-6">
              ...
              <div className="flex items-center justify-center mt-6">
                ...
                <a
                  href="#"
                  className="w-1/3 pb-4 font-medium text-center  capitalize border-b-2 border-blue-500 dark:border-blue-400 "
                >
                  sign up
                </a>
              </div>
              ...
              <div className="relative flex items-center mt-6">
                <span className="absolute">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="w-6 h-6 mx-3  dark:text-gray-500"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    stroke-width="2"
